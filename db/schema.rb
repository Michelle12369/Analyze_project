...
ActiveRecord::Schema.define(version: 20150616163401) do
  ...
  add_index "a03a3_group", ["Tour_Code"], name: "index_a03a3_group_on_Tour_Code", using: :btree
  ...
  add_index "a04a1_agentno", ["Agent_No"], name: "index_a04a1_agentno_on_Agent_No", using: :btree
  ...
  add_index "a05b00_order", ["Order_No"], name: "index_a05b00_order_on_Order_No", using: :btree
  ...
  add_index "b01a2_activity", ["Service_Id"], name: "index_b01a2_activity_on_Service_id", using: :btree
  ...
  add_index "b01a2_groupclick", ["Activity_Seq"], name: "index_b01a2_groupclick_on_Activity_Seq", using: :btree
